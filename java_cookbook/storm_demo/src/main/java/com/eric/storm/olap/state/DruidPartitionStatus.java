...
public class DruidPartitionStatus {
    ...
    private final String BASE_ZK_PATH="/statsip/druid/pstatus/";
    private final String COMPLETED_PATH = BASE_ZK_PATH+"completed";
    private final String LIMBO_PATH = BASE_ZK_PATH+"limbo";
    private final String CURRENT_PATH = BASE_ZK_PATH+"current";
    private CuratorFramework curatorFramework;

    public DruidPartitionStatus() {
        try {
            curatorFramework = CuratorFrameworkFactory.builder().namespace("stormdruid")
                    .connectString("10.5.25.18:2181").retryPolicy(new RetryNTimes(1, 1000)).connectionTimeoutMs(5000)
                    .build();
